...
/// Renders the Job detail panel window for the currently selected job.
/// Shows editable fields (name, description, notes) and the list of linked
/// customer segments. Does nothing when no job is selected.
